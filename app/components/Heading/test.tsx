...
describe('<Heading />', () => {
  it('should render a white heading by default', () => {
    render(<Heading>Front Jobs</Heading>)
  ...
  it('should render a black heading when color is passed', () => {
    render(<Heading color="black">Front Jobs</Heading>)
    expect(screen.getByRole('heading', { name: /Front Jobs/i })).toHaveStyle({
      color: '#030517'
    })
  })
  ...
  it('should render a heading whith a line to the left side', () => {
    render(<Heading lineLeft>Front Jobs</Heading>)
    expect(screen.getByRole('heading', { name: /Front Jobs/i })).toHaveStyle({
  ...
  it('should render a heading whith a line at the bottom', () => {
    render(<Heading lineBottom>Front Jobs</Heading>)
    expect(
  ...
  it('should render a heading with a huge size', () => {
    render(<Heading size="huge">Front Jobs</Heading>)
  ...
  it('should render a heading whith a small size', () => {
    render(<Heading size="small">Front Jobs</Heading>)
    expect(screen.getByRole('heading', { name: /Front Jobs/i })).toHaveStyle({
      'font-size': '1.6rem'
    })
